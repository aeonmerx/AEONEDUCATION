<!-- COMPONENTE #7 SUSCRIPCIONES  -->
<section id="specials" class="specials" style="background-color: blue;">
                    ...
                    <div class="col-lg-3">
                        <ul class="nav nav-tabs flex-column">
                            <li class="nav-item"> <a class="nav-link active show" data-bs-toggle="tab"
                                    href="#tab-1">VIP BRONCE</a></li>
                            <li class="nav-item"> <a class="nav-link" data-bs-toggle="tab" href="#tab-2">VIP ESMERALDA</a></li>
                            <li class="nav-item"> <a class="nav-link" data-bs-toggle="tab" href="#tab-3">VIP DIAMANTE</a></li>
                        </ul>
                    </div>
                            ...
                            <div class="tab-pane active show" id="tab-1">
                                <div class="row">
                                    <div class="col-lg-8 details order-2 order-lg-1">
                                        <h3>VIP BRONCE BENEFICIOS</h3>
                                        <p class="fst-italic">Tener acceso a todos nuestros cursos</p>
                                    ...
                                    <div class="col-lg-4 text-center order-1 order-lg-2"> <img
                                            src="https://cdn.pixabay.com/photo/2015/07/27/20/16/book-863418_960_720.jpg" alt="" class="img-fluid"></div>
                                </div>
                            </div>
                            <div class="tab-pane" id="tab-2">
                                <div class="row">
                                    <div class="col-lg-8 details order-2 order-lg-1">
                                        <h3>VIP ESMERALDA BENEFICIOS</h3>
